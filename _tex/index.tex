...
\hypersetup{
  pdftitle={Adipose \& MAFLD},
  pdfauthor={Jose M. Arbones Mainar; Laura Puente; Alberto Cebollada},
  pdfkeywords={Adipose, Liver disease, Multiomics, eQTL},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
  citecolor={Blue},
...
\journalname{Journal of Parampount Bullshit}
...
\authors{Jose M. Arbones Mainar\affil{1,2,3}, Laura
Puente\affil{1}, Alberto Cebollada\affil{1}}
\affiliation{1}{Instituto Aragonés de Ciencias de la
Salud, }\affiliation{2}{Instituto de Investigación Sanitaria
Aragón, }\affiliation{3}{Ciber Obesidad y Nutrición, }



\begin{abstract}
White adipose tissue (WAT) is a metabolic organ of paramount importance
in the regulation of whole-body energy homeostasis. \ldots{}
\end{abstract}
...
\textsubscript{Source:
\href{https://arbones.github.io/TFM/index.qmd.html}{Article Notebook}}
...
\textsubscript{Source:
\href{https://arbones.github.io/TFM/notebooks/explore-earthquakes-preview.html\#cell-fig-spatial-plot}{Explore
Earthquakes}}
