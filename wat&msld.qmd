...
Its role extends beyond fat storage, influencing whole-body physiology and contributing to various conditions, notably obesity and its complications such as metabolic dysfunction-associated steatotic liver disease (MASLD).
...
MASLD, formerly known as Non-alcoholic fatty liver disease (NAFLD), is a progressive liver disease characterized by the build-up of fat in the liver of individuals with little or no alcohol intake.
While diagnosing NAFLD mainly involved excluding significant or excessive alcohol consumption, MASLD include metabolic risk factors in their diagnostic criteria [@rinella2023].
